...
const faqs = [
  ...
  {
    q: '顧問税理士を変える必要はありますか？',
    a: 'ありません。既存の顧問税理士はそのままに、節税スキームの設計・規程整備・運用フローの構築までPLEXがサポートします。',
  },
  {
    q: '顧問税理士・節税コンサルとの違いは？',
    a: '顧問税理士は申告中心で節税の能動提案は限定的、節税コンサルは提案後の運用と否認リスクが顧客に残ります。PLEXは「提案＋導入サポート＋否認補償」までセットで提供します。',
  },
  {
    q: '対応エリアはありますか？',
    a: '全国対応可能です。お打ち合わせはオンライン中心、必要に応じて訪問対応します。',
  },
  {
